...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Copy2contact</application>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Copy2contact__c.password__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Pricebook2.Lead__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Pricebook2.Price__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Product2.Product_Price__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>Copy2contact__c-Copy2contact Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <pageAccesses>
        <apexPage>JS_object_displaying</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
    ...
    <pageAccesses>
        <apexPage>ajax_toolkit</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
    ...
    <pageAccesses>
        <apexPage>customForm</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>customResource</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>firstApex</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>mapPage</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>redirectPage</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>redirect_page</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
